...
class User(AbstractUser):
    ...
    phone = models.TextField(max_length=64, null=True, verbose_name='Номер телефона')
    avatar = models.ImageField(upload_to=avatar_directory_path, null=True, blank=True, verbose_name='Фотография')
    region = models.TextField(max_length=512, null=True, blank=True, verbose_name='Регион')
    city = models.TextField(max_length=512, null=True, blank=True, verbose_name='Город')
    street = models.TextField(max_length=512, null=True, blank=True, verbose_name='Улица')
