...
from .views import (create_user, update_user_info, get_user_info, csrf, vets_list, upload_user_avatar, protected_file, test, get_vet_user_info, update_vet_user_info)
