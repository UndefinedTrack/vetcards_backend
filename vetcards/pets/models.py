...
class Pet(models.Model):
    ...
    breed = models.TextField(max_length=128, null=True, default='', blank=True, verbose_name='Порода')
    color = models.TextField(max_length=128, null=True, default='', blank=True, verbose_name='Окрас')
    birth_date = models.TextField(max_length=10, null=True, default='', blank=True, verbose_name='Дата рождения')
    gender = models.TextField(max_length=10, null=True, default='', blank=True, verbose_name='Пол')
    chip = models.TextField(max_length=64, null=True, default='', blank=True, verbose_name='Чип')
    ...
    contraindications = models.TextField(max_length=512, null=True, blank=True, default='', verbose_name='Противопоказания')
    notes = models.TextField(max_length=512, null=True, blank=True, default='', verbose_name='Особые пометки')
